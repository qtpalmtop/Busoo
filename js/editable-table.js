    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[6].innerHTML = '<button class="btn btn-primary" style="position:absolute;right:278px">上传</button><input type="file" class="form-control small" style="position:relative;opacity:0;top:0px;cursor:pointer">';
